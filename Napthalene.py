...
post = [(0,-0.5,0), (-0.5,-0.5 -np.sqrt(3)/2,0), (-1,-0.5,0), (-1,0.5,0), (-0.5,0.5+np.sqrt(3)/2,0), (0,0.5,0), (0.5,0.5+np.sqrt(3)/2,0), (1,0.5,0), (1,-0.5,0), (0.5,-0.5 -np.sqrt(3)/2,0)] # Napthalene
